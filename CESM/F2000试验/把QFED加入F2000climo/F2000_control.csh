#!/bin/csh -fx
# ====================================================================
# CESM F2000climo Control Experiment
# Purpose: Baseline simulation without QFED fire emissions
# Author: Modified for fire emission study
# Date: 2025-11-24
# ====================================================================
...
# ====================================================================
# Clean old case if exists
# ====================================================================
if ( -e ${CASEROOT} ) then
    echo "Removing old case directory..."
    rm -rf $CASEROOT
endif

if ( -e ${RUNDIR} ) then
    echo "Removing old run directory..."
    rm -rf $RUNDIR
endif
...
# ====================================================================
# Create user_nl_cam with output variables
# ====================================================================
echo "Creating user_nl_cam..."
cd $CASEROOT
...
! ===== Fire-related Output Variables (VERIFIED) =====
fincl1 = 
! Fire emission fluxes
         'SFbc_a4','SFpom_a4','SFbc_a1','SFpom_a1',
         'SFso4_a1','SFso4_a2','SFSO2','SFH2SO4',
         'SFnum_a1','SFnum_a2','SFnum_a4',
         
! Aerosol concentrations - 3D
         'bc_a4','pom_a4','bc_a1','pom_a1',
         'so4_a1','so4_a2',
         'dst_a1','dst_a2','dst_a3',
         'num_a1','num_a2','num_a4',
         
! Surface concentrations
         'bc_a4_SRF','pom_a4_SRF','bc_a1_SRF','pom_a1_SRF',
         'so4_a1_SRF','so4_a2_SRF',
         'dst_a1_SRF','dst_a2_SRF','dst_a3_SRF',
         
! Aerosol optical properties
         'AODPOM','AODSOA','AODDUST','AODDUST1','AODDUST3',
         'AEROD_v','AODVIS',
...
! Trace gases
         'SO2','SO2_SRF','DMS','DMS_SRF',
         'H2O2','H2SO4','SOAG',
         
! Radiation fluxes
         'FSNT','FSNTC','FLNT','FLNTC',
         'FSDS','FSDSC','FLDS',
         'SWCF','LWCF',
         
! Clouds
         'CLDTOT','CLDLOW','CLDMED','CLDHGH',
         'CDNUMC','CLOUD','CLDLIQ','CLDICE',
         
! Precipitation
         'PRECT','PRECC','PRECL',
         
! Meteorology - 3D
         'T','U','V','OMEGA','Q','RELHUM',
         
! Meteorology - surface
         'PS','PSL','TS','TREFHT','QREFHT',
         'UBOT','VBOT','U10',
         'PBLH','LHFLX','SHFLX'
...
echo "Building case (this may take 10-20 minutes)..."
...
echo "======================================================================"
echo "Control experiment submitted!"
echo "Case directory: $CASEROOT"
echo "Run directory: $RUNDIR/run"
echo "======================================================================"
echo "Monitor with:"
echo "  bjobs"
echo "  tail -f $RUNDIR/run/cesm.log.*"
echo "======================================================================"
