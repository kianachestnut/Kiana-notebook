...
# Modified for correct QFED data path
...
! ===== QFED Fire Emissions =====
! Variable name confirmed: biomass
! Units confirmed: kg s-1 m-2 (correct for CESM)
! Note: QFED directory name is QEFD (not QFED)
