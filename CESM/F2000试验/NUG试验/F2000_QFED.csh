...
# Modified to add QFED fire emissions for July 2018
# ====================================================================
# define directories
# ====================================================================
setenv MACH hpcc
...
fincl1 = 'PRECT','T','U','V','U10','bc_a4','pom_a4','SO4_a1','SO4_a2','SO4_a3','SFBC','SFPOM','SFSO4'
...
! ===== QFED Fire Emissions Configuration =====
! Use external forcing for fire emissions
ext_frc_type = 'SERIAL'
ext_frc_cycle_yr = 2018

! Specify QFED emission files - CRITICAL: Check variable names in your QFED files
! QFED typically uses 'biomass' as variable name, you may need to verify this
...
! Alternative approach: use ext_frc_specifier for elevated emissions (if needed)
